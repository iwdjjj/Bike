...
namespace Bike.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public List<SelectListItem> Doljnosts { get; set; }
        /// <summary>
        ///     This API supports the ASP.NET Core Identity default UI infrastructure and is not intended to be used
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public class InputModel
        {
            ...
            [Required]
            [StringLength(255, MinimumLength = 2, ErrorMessage = "The {0} must be at least {2} and at max {1} characters long.")]
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Doljnosts = _context.Doljnosts.Select(x => new SelectListItem() { Value = x.DoljnostId.ToString(), Text = x.DoljnostName }).ToList();
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.DoljnostId = Input.DoljnostId;
                ...
                if (result.Succeeded)
                {
                    if (user.DoljnostId == 1) { var rezult = await _userManager.AddToRoleAsync(user, "Administrator"); }
                    else { var rezult = await _userManager.AddToRoleAsync(user, "Guest"); }
